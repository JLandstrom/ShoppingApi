        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingItems_ItemCategories_ItemCategoryId",
            ...
            migrationBuilder.InsertData(
                table: "ShoppingLists",
                columns: new[] { "ListId", "Name", "Status" },
                values: new object[] { 1, "TestList", 0 });

            migrationBuilder.InsertData(
                table: "ShoppingItems",
                columns: new[] { "ItemId", "ItemCategoryId", "Name", "Quantity", "ShoppingListId", "UnitOfMeasure" },
                values: new object[] { 1, 1, "TestItem", 1, 1, "kg" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingItems_ItemCategoryId",
                table: "ShoppingItems",
